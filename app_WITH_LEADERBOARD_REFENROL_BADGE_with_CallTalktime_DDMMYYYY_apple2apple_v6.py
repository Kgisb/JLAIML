...
def _ata_render():
    ...
    # Optional global data range pre-filter (applies before Window A/B)
    ...
    # Totals
    totA = _ata_metric_totals(f, metric, startA, endA)
    totB = _ata_metric_totals(f, metric, startB, endB)
